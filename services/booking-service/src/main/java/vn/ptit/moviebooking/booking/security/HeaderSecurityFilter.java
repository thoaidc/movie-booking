...
import vn.ptit.moviebooking.booking.common.JsonUtils;
import vn.ptit.moviebooking.booking.dto.BaseUserDTO;
import vn.ptit.moviebooking.booking.dto.response.BaseResponseDTO;
import vn.ptit.moviebooking.booking.exception.BaseBadRequestAlertException;
import vn.ptit.moviebooking.booking.exception.BaseException;
...
public class HeaderSecurityFilter extends OncePerRequestFilter {
    ...
    protected void authenticate(HttpServletRequest request) {
        ...
        try {
            ...
            throw new BaseBadRequestAlertException("HeaderSecurityFilter", "Không thể xác thực");
        }
    }
}
